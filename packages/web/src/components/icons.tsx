...
export function ChevronRightIcon({ size = 14, style }: IconProps & { style?: React.CSSProperties }) {
  return (
    <svg
...
export function ErrorCircleIcon({ size = 14 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="var(--color-failed)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
